...
export class OrderService {
  static async getRentalOrders(filters = {}) {
    try {
  ...
  static async getRentalOrder(id) {
    try {
  ...
  static async createRentalOrder(orderData) {
    try {
  ...
  static async updateRentalOrder(id, updates) {
    try {
  ...
  static async deleteRentalOrder(id) {
    try {
  ...
  static async updateInventoryReservation(itemId, quantity, operation = 'add') {
    try {
  ...
  static async releaseOrderInventory(orderId) {
    try {
