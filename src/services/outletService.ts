...
class OutletService {
  ...
  static async getAllOutlets(): Promise<Outlet[]> {
    try {
      ...
      const mappedOutlets = data.map((location: any) => ({
        id: location.id,
        code: location.code, // Use 'code' field (auto-generated by trigger)
        name: location.name,
        address: {
        ...
        contact_person: location.contact_person || (location.manager_id ? 'Manager' : 'N/A'),
  ...
  static async getOutletById(id: string): Promise<Outlet | null> {
    try {
      ...
      return {
        id: data.id,
        code: data.code, // Auto-generated by trigger
        name: data.name,
        address: {
          street: data.address,
          city: data.city,
  ...
  static async createOutlet(outletData: OutletFormData): Promise<Outlet> {
    try {
      // Code will be auto-generated by database trigger (HYBITS-001, etc.)
      ...
      const insertData: any = {
        ...
        country: (outletData as any).country || 'India',
        contact_person: (outletData as any).contact_person || null,
        contact_phone: outletData.contact_phone,
        contact_email: outletData.contact_email,
        manager_id: outletData.manager_id || null,
        is_active: outletData.is_active !== undefined ? outletData.is_active : true
      };

      console.log('Creating outlet with data:', insertData);
      ...
      return {
        ...
        contact_person: data.contact_person || (data.manager_id ? 'Manager' : 'N/A'),
  ...
  static async updateOutlet(id: string, updates: Partial<OutletFormData>): Promise<Outlet> {
    try {
      ...
      if ((updates as any).contact_person) updateData.contact_person = (updates as any).contact_person;
